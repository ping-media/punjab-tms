            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <?php echo form_open(admin_url('tms/consignors/create'), ['id' => 'consignor-form']); ?>
                        <h4 class="no-margin"><?php echo _l('new_consignor'); ?></h4>
                        <hr class="hr-panel-heading" />
                        <div class="row">
                            <div class="col-md-6">
                                <?php echo render_input('company', 'company_name', '', 'text', ['required' => true]); ?>
                                <?php echo render_input('contact_person', 'contact_person', '', 'text', ['required' => true]); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <?php echo render_input('city', 'city', '', 'text', ['required' => true]); ?>
                                <?php 
                                    $states = [];
