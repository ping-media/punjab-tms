...
<div id="wrapper">
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="tw-mb-3">
                    <h4 class="tw-my-0 tw-font-bold tw-text-xl">Consignors</h4>
                </div>
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="_buttons">
                            <?php if (has_permission('tms', '', 'create')) { ?>
                                <a href="<?php echo admin_url('tms/consignors/create'); ?>" class="btn btn-primary pull-left display-block">
                                <i class="fa-regular fa-plus tw-mr-1"></i>
                                <?php echo _l('new_consignor'); ?>
                                </a>
                            <?php } ?>
                        </div>
                        ...
                        render_datatable($table_data, 'consignors');
                        ?>
                    </div>
                </div>
            </div>
...
<script>
$(function() {
    initDataTable('.table-consignors', window.location.href, [], [], undefined, [0, 'desc']);
